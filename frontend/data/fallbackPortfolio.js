  ...
  experience: [
    {
      ...
      impact:
        "Developed enterprise RAG systems for internal knowledge automation, embedding pipelines with OpenAI API and LangChain, semantic search with PostgreSQL and pgVector, and production REST APIs."
    },
    {
      company: "ERSko",
      ...
      impact:
        "Built and deployed an AI-powered assistant used by 1000+ users with RAG architecture, OpenAI integrations, LangChain workflows, pgVector, and a MERN-based product surface."
    },
    {
      ...
      impact:
        "Founded and patented a modular fogponic growing system, designing both the hardware architecture and the automation software layer."
    },
    {
      company: "Sopkomat",
      ...
      impact:
        "Developed a smart vending workflow, built an admin surface, and integrated Raspberry Pi control for real-time product management."
    }
  ],
  projects: [
    {
      ...
      outcome: "Used by 1000+ users in a real deployment.",
      accent: "purple"
    },
    {
